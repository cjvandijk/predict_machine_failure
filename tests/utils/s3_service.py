...
class S3Storage:
    ...
    def __init__(self) -> None:
        ...
        self._s3_resource = boto3.resource(
            "s3", region_name="us-east-2", endpoint_url=self._endpoint_url
        )
        self._s3_client = boto3.client(
            "s3", region_name="us-west-2", endpoint_url=self._endpoint_url
        )
    ...
    def upload_to_aws(self, local_file, bucket_name, s3_file):
        ...
        print(f"~~~~~~~~~~~UPLOADING {local_file} to {bucket_name}/{s3_file}")
